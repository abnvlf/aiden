...
struc KERNEL_NETWORK_FRAME_TCP
    .type resb 0x01
    .code resb 0x01
    .checksum resb 0x02
    .reserved resb 0x04
...
struc KERNEL_NETWORK_STRUCTURE_FRAME_TCP
    ...
    .flags resb 0x01
    .windows_size resb 0x02
    .checksum_and_urgent_pointer:
    .checksum resb 0x02
    .urgen_pointer resb 0x02
    .options:
endstruc
...
kernel_network:
    xor ebp, ebp
    cmp word [rsi + KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.type], KERNEL_NETWORK_FRAME_TYPE_arp
    je kernel_network_arp

    cmp word [rsi + KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.type], KERNEL_NETWORK_FRAME_TYPE_ip
...
kernel_network_tcp:
    ...
    cmp byte [rsi + KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_IP.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_TCP.flags], KERNEL_NETWORK_FRAME_TCP_FLAGS_fin
...
kernel_network_tcp_psh_ack:
    ...
    shr dl, STATIC_MOV_AL_HALF_TO_HIGH_shift
...
.wait:
    bts word [rsi + KERNEL_NETWORK_STRUCTURE_PORT.cr3_and_flags], KERNEL_NETWORK_PORT_FLAGS_BIT_empty
    jnc .empty
...
kernel_network_tcp_fin:
    ...
    bswap eax
    inc eax
    mov dword [rsi + KERNEL_NETWORK_STRUCTURE_TCP_STACK.source_semaphore], eax

    mov eax, dword [rsi + KERNEL_STRUCTURE_TCP_STACK.request_acknowledgement]
    inc eax
    mov dword [rsi + KERNEL_NETWORK_STRUCTURE_TCP_STACK.request_acknowledgement], eax

    mov word [rsi + KERNEL_NETWORK_STRUCTURE_TCP_STACK.flags], KERNEL_STRUCTURE_FRAME_TCP_FLAGS_ack | KERNEL_NETWORK_FRAME_TCP_FLAGS_fin
    mov word [rsi + KERNEL_NETWORK_STRUCTURE_TCP_STACK.flags_request], KERNEL_NETWORK_FRAME_TCP_FLAGS_ack

    call kernel_memory_alloc_page
    jc .error

    mov bl, (KENREL_NETWORK_STRUCTURE_FRAME_TCP.SIZE >> STATIC_DIVIDE_BY_4_shift) << STATIC_MOVE_AL_HALF_TO_HIGH_shift
    mov ecx, KERNEL_NETWORK_STRUCTURE_FRAME_TCP.SIZE
    call kernel_network_tcp_wrap

    mov ax, KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_IP.SIZE + KERNEL_NETWORK_STRUCTURE_TCP.SIZE + STATIC_DWORD_SIZE_byte
    call driver_nice_i82540em_transfer
...
kernel_network_tcp_ack:
    ...
    and word [rdi + KERNEL_NETWORK_STUCTURE_TCP_STACK.flags_request], ~KERNEL_NETWOKR_FRAME_FLAGS_ack

    test word [rdi + KERNEL_NETWORK_STRUCTURE_TCP_STACK.flags], KERNEL_NETWORK_TCP_FLAGS_fin | KERNEL_NETWORK_FRAME_TCP_FLAGS_ack
    jz .end
...
kernel_network_tcp_find:
    ...
    and bl, KERNEL_NETWORK_IP_HEADER_LENGTH_mask
...
.loop:
    ...
    rol rax, STATIC_REPLY_WITH_HIGH_shift
    ...
    mov ax, word [rdi + KERNEL_STRUCTURE_TCP_STACK.source_port]
...
.search:
    lock bts word [rdi + KERNEL_NETWORK_STRUCTURE_TCP_STACK.status], KERNEL_STRUCTURE_STACK_FLAG_busy
    jnc .found
...
.found:
    ...
    and cl, KERNEL_NETWORK_IP_HEADER_LENGTH_mask
    shl cl, STATIC_MUTLIPLE_BY_4_shift
    ...
    bswap eax
    inc eax
    mov dword [rdi + KERNEL_NETWORK_STRUCTURE_TCP_STACK.source_semaphore], eax

    mov rcx, qword [rsi + KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.sourece]
    ...
    mov word [rdi + KERNEL_NETWORK_STRUCTURE_TCP_STACK.windows_size], KERNEL_NETWORK_FRAME_TCP_WINDOW_SIZE_default
    ...
    mov word [rdi + KERNEL_NETWORK_STRUCTURE_TCP_STACK.flag_request], KERNEL_NETWORK_FRAME_TCP_FLAGS_ack
    mov rsi, rdi
...
kernel_network_tcp_wrap:
    ...
    mov bl, KERNEL_NETWORK_FRAME_IP_PTOROCOL_TCP
...
kernel_network_ip_wrap:
    ...
    rol cx, STATIC_REPLACE_AL_WITH_HIGH_shift
    mov word [rdi + KERNEL_NETWORK_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_IP.total_length], cx
    ...
    mov eax, dword [rsi + KERNEL_NETWORK_TCP_STACK.source_ipv4]
    ...
    add rdi, KERNEL_NETWORK_STRUCTURE_FRAME_EHTERNET.SIZE
    call kernel_network_checksum
    rol ax, STATIC_REPLACE_AL_WITH_HIGH_shift
    sub rdi, KERNEL_NETWORK_FRAME_ETHERNET.SIZE
    mov word [rdi + KERNEL_NETWORK_STRUCTURE_FRAME_EHTERNET.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_IP.checksum], ax
    ...
    call kernel_network_checksum
    rol ax, STATIC_REPLACE_AL_WITH_HIGH_shift
    sub rdi, KERNEL_NETWORK_STRUCTURE_ETHERNET.SIZE
...
kernel_network_tcp_pseudo_header:
    ...
    mov eax, dword [rsi + KERNEL_STRUCTURE_TCP_STACK.source_ipv4]
    ...
    mov byte byte [rdi + KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_IP.SIZE - KERNEL_NETWORK_STRUCTURE_FRAME_TCP_PSEUDO_HEADER.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_TCP_PSEUDO_HEADER.protocol], KERNEL_NETWORK_FRAME_TCP_PROTOCOL_default

    rol rcx, STATIC_REPLACE_AL_WITH_HIGH_shift
    mov word word [rdi + KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_IP.SIZE - KERNEL_NETWORK_STRUCTURE_FRAME_TCP_PSEUDO_HEADER.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_TCP_PSEUDO_HEADER.segment_length], cx

    xor eax, eax
    mov ecx, KERNEL_STRUCTURE_FRAME_TCP_PSEUDO_HEADER.SIZE >> STATIC_DIVIDE_BY_2_shift
...
kernel_network_tcp_port_receive:
    ...
    and ecx, STATIC_QWORD_mask
    shl ecx, STATIC_MULTIPLE_BY_32_shift
    ...
    mov rcx, qword [rsi + KENREL_NETWORK_STRUCTURE_PORT.cr3_and_flags]
...
kernel_network_tcp_arp:
    ...
    cmp byte [rsi + KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + KENREL_NETWORK_STRUCTURE_FRAME_ARP.hal], KERNEL_NETWORK_FRAME_ARP_HAL_mac
    jne .omit
    ...
    mov word [rdi + KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_ARP.ptype], KERNEL_NETWORK_FRAME_ARP_HAL_mac
    ...
    mov eax, KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_AP.SIZE
    call service_tx_add
...
kernel_network_icmp:
    ...
    mov word [rdi + KERNEL_NETWORK_STRUCTURE_FRAME_ETHERNET.type], KERNEL_NETWORK_ETHERNET_TYPE_ip
    ...
    mov eax, KERNEL_NETWROK_STRUCTURE_FRAME_ETHERNET.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_IP.SIZE + KERNEL_NETWORK_STRUCTURE_FRAME_ICMP.SIZE
    call driver_nic_i82540em_transfer
