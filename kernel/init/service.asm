kernel_init_service:
    mov rsi, kernel_init_service_list
...
.loop:
    ...
    mov rbx, KERNEL_PAGE_FLAG_available | KERNEL_PAGE_FLAG_available
    ...
    mov bx, KERNEL_TASK_FLAG_active | KERNEL_TASK_FLAG_active | KERNEL_TASK_FLAG_secured
