...
struc SERVICE_NETWORK_FRAME_UDP
...
.loop:
  ...
  cmp word [rsi + SERVICE_NETWORK_STRUCTURE_FRAME_ETHERNET_TYPE.type], SERVICE_NETWORK_FRAME_ETHERNET_TYPE_ip
...
service_network_tcp_port_send:
  ...
  inc dword [rbx + SERVICE_NETWORK_TCP_STACK.host_sequence]
...
service_network_ip:
	cmp byte [rsi + SERVICE_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + SERVICE_NETWORK_FRAME_IP.protocol], SERVICE_NETWORK_IP_PROTOCOL_ICMP
...
service_network_tcp:
	...
	test byte [rsi + SERVICE_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + SERVICE_NETWORK_STRUCTURE_FRAME_IP.SIZE + SERVICE_NETWORK_STRUCTURE_FRAME_TCP.flags], SERVICE_NETWORK_TCP_FLAGS_fin
...
service_network_tcp_psh_ack:
	...
	movzx ecx, word [rsi + SERVICE_NETWOKR_STRUCTURE_FRAME_ETHERNET.SIZE + SERVICE_NETWORK_STRUCTURE_FRAME_IP.total_length]
...
service_network_tcp_fin:
	...
	mov word [rsi + SERVICE_STRUCTURE_TCP_STACK.flags_request], SERVICE_NETWORK_FRAME_TCP_FLAGS_ack
...
service_network_tcp_port_receive:
	...
	test word [rsi + SERVICE_NETWORK_STRUCTURE_PORT.cr3_and_flags], SERVICE_NETWORK_PORT_FLAG_memory | SERVICE_NETWORK_PORT_FLAG_received
	jz .error

	and word [rsi + SERVICE_NETWORK_STRUCTURE_PORT.cr3_and_flags], ~SERVICE_NETWORK_PORT_FLAG_BIT_received
	mov rbx, qwrod [rsi + SERVICE_NETWORK_STRUCTURE_PORT.tcp_connection]
...
service_network_arp:
	...
	mov eax, dword [rsi + SERVICE_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + SERVICE_NETWORK_STRUCTUER_FRAME_ARP.source_ip]
	...
	mov rax, qword [rsi + SERVICE_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + SERVICE_NETWORK_STRUCTURE_FRAME_ARP.target_mac + SERVICE_NETWORK_STRUCTURE_MAC.4], ax

	mov rax, qword [rsi + SERVICE_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + SERVICE_NETWORK_STRUCTURE_FRAME_ARP.source_mac]
	mov cx, SERVICE_NETWORK_FRAME_ETHERNET_TYPE_arp
	call service_network_ethernet_arp
...
service_network_icmp:
	...
	mov eax, dword [rdi + SERVICE_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + SERVICE_NETWORK_STRUCTURE_FRAME_IP.source_address]
	...
	mov eax, SERVICE_NETWORK_STRUCTURE_FRAME_ETHERNET.SIZE + SERVICE_NETWORK_STRUCTURE_FRAME_IP.SIZE + SERVICE_NETWORK_STRUCTURE_ICMP.SIZE
	call service_network_transfer
